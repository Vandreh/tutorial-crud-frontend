...
function App() {
  ...
  async function getTodos() {
    const response = await axios.get("https://reactnodepostgresql.herokuapp.com/todos");
    setTodos(response.data);
    console.log(response.data);
  }
  async function editTodo() {
    const response = await axios.put("https://reactnodepostgresql.herokuapp.com/todos", {
      id: selectedTodo.id,
      name: inputValue,
    });
    setSelectedTodo();
  ...
  async function deleteTodo(todo) {
    const response = await axios.delete(
      `https://reactnodepostgresql.herokuapp.com/todos/${todo.id}`
    );
    getTodos();
  }
  ...
  async function createTodo() {
    const response = await axios.post("https://reactnodepostgresql.herokuapp.com/todos", {
      name: inputValue,
    });
    getTodos();
    setInputVisility(!inputVisbility);
